...
switch ($section) {
    case 'popular':
        $items = tmdb_movie_popular($page);
        break;
    case 'now_playing':
        $items = tmdb_movie_now_playing($page);
        break;
    case 'upcoming':
        $items = tmdb_movie_upcoming($page);
        break;
    case 'top_rated':
        $items = tmdb_movie_top_rated($page);
        break;
    default:
        $items = tmdb_movie_trending($page);
        break;
}

function kp_movie_url($section, $page = 1) {
    return './movies.php?' . http_build_query(['section' => $section, 'page' => max(1, (int)$page)]);
}
?>
...
<div class="home-index-con">
    ...
    <div class="show-container">
        <div class="head-show">
            <i class="fa-solid fa-fire" style="color:#ff2e63;"></i>
        ...
        <?php else: ?>
            ...
            <div class="kp-pagination">
                <?php if ($page > 1): ?>
                    <a class="kp-page-btn" href="<?= kp_e(kp_movie_url($section, $page - 1)) ?>">
